...
const EN: Record<string, string> = {
  ...
  "Projeto: ": "Project: ",
  "Projeto: {p} — clica para abrir a pasta": "Project: {p} — click to open the folder",
  "Pré-visualizar ficheiros do projeto": "Preview project files",
  ...
  "Pesquisar": "Search",
  "Think": "Think",
  "Nível de raciocínio (Think)": "Reasoning level (Think)",
  "Escolher nível de Think": "Choose Think level",
  "Think (raciocínio)": "Think (reasoning)",
  "Nativo (pensar)": "Native (think)",
  "Verificar (consenso)": "Verify (consensus)",
  "Debater": "Debate",
  ...
  "Plano": "Plan",
  "Plan mode: rascunha um plano de passos, aprovas/editas, e executa passo a passo":
    "Plan mode: drafts a step-by-step plan you approve/edit, then executes it step by step",
  "A planear…": "Planning…",
  "a planear…": "planning…",
  ...
  "Reinicia o Ollama (fecha e reabre) para ter efeito.":
    "Restart Ollama (quit and reopen) for it to take effect.",
  ...
  "Não foi possível ler {name}.": "Couldn't read {name}.",
  "Estilo do PDF": "PDF style",
  "Artigo": "Article",
  "Técnico": "Technical",
